...
train_grid(algorithm = 'randomForest', 
           ...
           grid_id = 'xrt_grid_featured', 
           params = params, 
           search_criteria = search_criteria)

xrt_grid <- h2o.loadGrid('grids/xrt_grid_featured/xrt_grid_featured')
top_xrt <- h2o.getModel(xrt_grid@model_ids[[1]])

h2o.performance(top_xrt, as.h2o(test_featured_baked))
